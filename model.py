...
os.environ['GROQ_API_KEY'] = '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'
client = Groq()
...
"""},
    ...
    while True:
        ...
        step_data = make_api_call(messages, 6000, custom_client=custom_client)
        end_time = time.time()
    ...
    start_time = time.time()
    final_data = make_api_call(messages, 6000, is_final_answer=True, custom_client=custom_client)
    end_time = time.time()
    thinking_time = end_time - start_time
    total_thinking_time += thinking_time
